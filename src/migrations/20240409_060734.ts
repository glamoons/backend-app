...
CREATE TABLE IF NOT EXISTS "media" (
	...
	"sizes_card_large_url" varchar,
	"sizes_card_large_width" numeric,
	"sizes_card_large_height" numeric,
	"sizes_card_large_mime_type" varchar,
	"sizes_card_large_filesize" numeric,
	"sizes_card_large_filename" varchar,
...
CREATE INDEX IF NOT EXISTS "media_sizes_card_large_sizes_card_large_filename_idx" ON "media" ("sizes_card_large_filename");
